...
4. In Authentication, enable email + password. Turn on magic-link email if you want one-time links. Add `http://localhost:3000/auth/callback` (and the production origin) to Redirect URLs.
